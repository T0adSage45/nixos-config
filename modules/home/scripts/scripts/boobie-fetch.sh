...
fetch() {
    echo "${cyan}$(tput bold) _________   _        _______           _______    ______   _______  _______  ______  _________ _______  _______   ${normal}$(tput sgr0)"
    echo "${cyan}$(tput bold) \__   __/  ( \      (  ___  )|\     /|(  ____ \  (  ___ \ (  ___  )(  ___  )(  ___ \ \__   __/(  ____ \(  ____ \/ ${normal}$(tput sgr0)"
    echo "${cyan}$(tput bold)    ) (     | (      | (   ) || )   ( || (    \/  | (   ) )| (   ) || (   ) || (   ) )   ) (   | (    \/| (    \/  ${normal}$(tput sgr0)"
    echo "${cyan}$(tput bold)    | |     | |      | |   | || |   | || (__      | (__/ / | |   | || |   | || (__/ /    | |   | (__    | (_____   ${normal}$(tput sgr0)"
    echo "${cyan}$(tput bold)    | |     | |      | |   | |( (   ) )|  __)     |  __ (  | |   | || |   | ||  __ (     | |   |  __)   (_____  )  ${normal}$(tput sgr0)"
    echo "${cyan}$(tput bold)    | |     | |      | |   | | \ \_/ / | (        | (  \ \ | |   | || |   | || (  \ \    | |   | (            ) |  ${normal}$(tput sgr0)"
    echo "${cyan}$(tput bold) ___) (___  | (____/\| (___) |  \   /  | (____/\  | )___) )| (___) || (___) || )___) )___) (___| (____/\/\____) |  ${normal}$(tput sgr0)"
    echo "${cyan}$(tput bold) \_______/  (_______/(_______)   \_/   (_______/  |/ \___/ (_______)(_______)|/ \___/ \_______/(_______/\_______)  ${normal}$(tput sgr0)"
    echo ""
    echo "  ╭─────────────╮ "
