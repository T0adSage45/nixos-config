  ...
  wayland.windowManager.hyprland = {
    settings = {
      ...
      bind = [
        ...
        "$mainMod SHIFT, B, exec, hyprctl dispatch exec '[workspace 1 silent] brave'"
	 ...
	 "$mainMod SHIFT, h, movewindow, l"
        ...
        "$mainMod SUPER, left, moveactive,  -80 0"
        "$mainMod SUPER, right, moveactive, 80 0"
        "$mainMod SUPER, up, moveactive, 0 -80"
        "$mainMod SUPER, down, moveactive, 0 80"
        "$mainMod SUPER, h, moveactive,  -80 0"
        "$mainMod SUPER, j, moveactive, 0 80"
        "$mainMod SUPER, k, moveactive, 0 -80"
        "$mainMod SUPER, l, moveactive, 80 0"
